...
define config.name = _("Operation Skipping School")
...
define build.name = "OperationSkippingSchool"
...
define config.save_directory = "OperationSkippingSchool-1614443508"
